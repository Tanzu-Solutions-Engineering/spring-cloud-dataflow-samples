...
package io.spring.cloud.dataflow.batch.uppercase;

import io.spring.cloud.dataflow.batch.uppercase.config.UppercaseConfiguration;
...
@ContextConfiguration(classes = { UppercaseConfiguration.class })
@EnableAutoConfiguration
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class UppercaseConfigurationTests {
	...
	public void clearMetadata() {
		...
		jdbcTemplate.execute("INSERT INTO Manager_1 (first_name, last_name) VALUES " +
				"('John', 'Doe')," +
				"('John', 'Doe')," +
				"('John', 'Doe')," +
				"('John', 'Doe')," +
	...
	public void cleanUp()
	{
		jdbcTemplate.execute("DELETE FROM Manager_1; DELETE FROM Manager_2");
	}
	...
	public void testNoParams() throws Exception {
		...
		CheckJobResult(jobExecution, PersonItemProcessor.Action.UPPERCASE);
	}
