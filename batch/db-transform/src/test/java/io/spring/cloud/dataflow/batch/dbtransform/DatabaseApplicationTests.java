...
package io.spring.cloud.dataflow.batch.dbtransform;

import io.spring.cloud.dataflow.batch.dbtransform.config.BatchProperty;
import io.spring.cloud.dataflow.batch.dbtransform.config.DatabaseConfiguration;
	...
	public void testUppercaseDatabaseTransform() throws Exception {
		...
		JobExecution jobExecution2 = jobLauncherTestUtils.launchJob(
				new JobParametersBuilder()
						...
						.toJobParameters());
		CheckJobResult(jobExecution2, PersonItemProcessor.Action.UPPERCASE);
	}
	...
	public void testBackwardsTransform() throws Exception {
		...
		JobExecution jobExecution3 = jobLauncherTestUtils.launchJob(
				new JobParametersBuilder()
						...
						.toJobParameters());
		CheckJobResult(jobExecution3, PersonItemProcessor.Action.BACKWARDS);
