...
package io.spring.cloud.dataflow.batch.lowercase;

import io.spring.cloud.dataflow.batch.lowercase.config.LowercaseConfiguration;
...
@ContextConfiguration(classes = { LowercaseConfiguration.class })
@EnableAutoConfiguration
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS )
public class LowercaseConfigurationTests {
	...
	public void testNoParams() throws Exception {
		...
		CheckJobResult(jobExecution, PersonItemProcessor.Action.LOWERCASE);
	}
